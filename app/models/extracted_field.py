...
class ExtractedField(Base):
    ...
    original_ocr_value: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    semantic_reason: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    officer_corrected_value: Mapped[str | None] = mapped_column(Text, nullable=True)
    officer_corrected_by: Mapped[int | None] = mapped_column(ForeignKey("users.id"), nullable=True)
    officer_corrected_at: Mapped[DateTime | None] = mapped_column(DateTime(timezone=True), nullable=True)
